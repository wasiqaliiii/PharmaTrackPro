...
namespace PharmaTrack
{
          ...
          m_settingsPage(nullptr)
    {
        ...
        m_scannerManager = new ScannerManager(this);

        m_scannerService = new ScannerService(this);

        m_configurationService = new ScannerConfigurationService(this);

        m_scannerService->setScannerManager(
            m_scannerManager);

        m_configurationService->setScannerManager(
            m_scannerManager);
    ...
    void MainWindow::createPages()
    {
        ...
        if (m_scannerManager)
        {
            m_scannerPage->setScannerManager(
                m_scannerManager);
        }

        if (m_scannerService)
        {
            m_scannerPage->setScannerService(
                m_scannerService);
        }
